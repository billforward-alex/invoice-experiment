...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("9de30053-30d1-4ec2-8e78-b9f43c861a48 restapi restapi 6955129065430413716".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in net.billforward package as a set of config entries
        return configLoader.fromResource("net/billforward/settings");
    }
